...
{
static int q;
static char write_size[BUFFEER_WRITE_FUNCTION];
...
*@write_flag: a flag to write 
*Retur: the string to be printed
*/
...
/**
*@prit_error_string - prints an input error string
*@ss: string to be printed 
*return: void
*/
...
/**
*putchar_error - writed charaaater to stderr
